...
---
Safeway is an American supermarket chain that has recently invested pretty heavily in modernizing their offerings and building out their mobile experience. They also have a pretty comprehensive coupon program, tied in with their app, which brought what used to be a painstaking process of clipping coupons from magazines to the slightly less painful process of having to click "Add" on every coupon every week after logging onto their site.
