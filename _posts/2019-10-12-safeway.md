---
title: "Safeway, bearer tokens, and not-so-extreme couponing"
date: 2019-10-12 10:16:27 -0700
header-img: "/images/safeway_added.png"
---
Safeway is an American supermarket chain that has recently invested pretty heavily in modernizing their offerings; they've started [offering online ordering and grocery delivery](https://www.bizjournals.com/denver/blog/finance_etc/2016/08/safeway-albertsons-launch-delivery-service-online.html). They also have a pretty comprehensive coupon program, tied in with their app, which brought what used to be a painstaking process of clipping coupons to the slightly less painful process of having to click "Add" on each individual one every time it shows up in app. 
