...
The above shows the stats for the reward based on the yelp rating. If we assume that 1, 2 and 5 star ratings are low-volume outliers, we see a _slight_ correlation, but not enough to draw any conclusions from.
