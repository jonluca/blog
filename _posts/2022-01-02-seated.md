---
title: "Reversing Seated's API to find the highest discount restaurants nearby"
...
Unfortunately their search doesn't let you sort by maximum cash back - you have to constantly move the map and just eyeball the highest one you see. I wanted to see if I could find all the restaurants and the ones with the highest returns.
...
Once I had all the data, I wanted to see where most restaurants fell, in terms of their reward distribution.
