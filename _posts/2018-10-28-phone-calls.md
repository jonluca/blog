...
It already sounds fairly tin-y. Minimizing the sample rate has a huge effect on the audio. It still sounds a _little_ too good though - you can make out background noises, and the frequencies are still distinct.
...
This sounds almost _exactly_ like a phone call. This was a suprisingly quick and fun exploration into signal processing, and into making high quality audio sound like a phone call.
