...
This blog is co-writte by [Ricky Moezinia](https://twitter.com/_ricky_mo)
...
{% include image.html footnote="Embedded Magic Link form (in this case, ImmutableX)" file="magic-onboarding-1" alt="magic link form" %}

{% include image.html footnote="Confirmation code for auth sign in" file="magic-onboarding-2" alt="magic link form 2" %}
...
{% include image.html footnote="Decrypted private key coming back from KMS" file="keymaterialresponse" alt="raw private key" %}
