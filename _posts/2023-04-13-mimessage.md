...
{% include image.html footnote="Your iMessage Wrapped" file="wrapped" alt="imessage wrapped" %}
...
{% include image.html footnote="Global search with filters" file="global-filter" alt="global search filter" %}
