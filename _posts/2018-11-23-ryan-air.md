...
{% picture "ryanair-flight-prices.png" --alt Ryanair flight prices %}
...
{% picture "ryanair-filtered-flight.png" --alt Ryanair filtered prices %}
...
{% picture "ryanair-filtered-html.png" --alt Ryanair filtered HTML %}
