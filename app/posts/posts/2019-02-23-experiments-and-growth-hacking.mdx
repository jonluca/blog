...
image: "https://assets.jonlu.ca/lyft-api-network.png"
---
...
<CustomImage file="lyft-api-network" footnote="Lyft experiments route" />

<p className={"footnote"}>Lyft experiments route</p>
...
<CustomImage file="burp-pt" footnote="Pinterest experiments route" />

<p className={"footnote"}>Burp Suite intercepting Pinterest API calls</p>
