...
image: "https://assets.jonlu.ca/usc-venmo4.png"
---
...
<CustomImage file="rmp-cd" footnote="Rate my professor cease and desist" />

<p className={"footnote"}>Viacom Cease & Desist</p>
...
<CustomImage file="uscsh-pre" footnote="Schedule helper before" />

<p className={"footnote"}>Before</p>

<CustomImage file="uscsh-after" footnote="Schedule helper after" />

<p className={"footnote"}>After</p>
...
<CustomImage file="uscsh-venmo" footnote="Venmo" />
...
<CustomImage file="usc-venmo1" footnote="venmo" />
<CustomImage file="usc-venmo2" footnote="venmo" />
<CustomImage file="usc-venmo3" footnote="venmo" />
<CustomImage file="usc-venmo4" footnote="venmo" />
