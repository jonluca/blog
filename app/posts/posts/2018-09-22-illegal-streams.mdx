...
image: "https://assets.jonlu.ca/vlc-hls.png"
---
...
<CustomImage file="hls" footnote="HLS" />

<p className={"footnote"}>
  Courtesy{" "}
  <a rel="noopener noreferrer" href="https://developer.apple.com/documentation/http_live_streaming">
    apple.com
  </a>
</p>
...
<CustomImage file="chunklist" footnote="List of chunks" />

<p className={"footnote"}>Finding the m3u8</p>

<CustomImage file="vlc-hls" footnote="VLC playing HLS standard" />

<p className={"footnote"}>Watching the stream in VLC with no ads</p>
...
<CustomImage file="scan-extension" footnote="Chrome extension network scan" />

<p className={"footnote"}>Scanning the current page for streams</p>
...
<CustomImage file="hls-index" footnote="HLS index" />

<p className={"footnote"}>Wrapper to hls.js</p>
...
<CustomImage file="unsafe-headers" footnote="Unsafe headers in XHR" />

<p className={"footnote"}>Chrome refuses to set certain headers</p>
...
<CustomImage file="electron-hls" footnote="Electron wrapper to site" />

<p className={"footnote"}>My static site running in Electron</p>
...
<CustomImage file="dark-mode-hls" footnote="Dark mode electron app" />

<p className={"footnote"}>Options to my static site</p>
...
<CustomImage file="fox-hls" footnote="Fox network requests" />

<p className={"footnote"}>Illegal stream to Fox</p>
...
<CustomImage file="keyserver-hls" footnote="HLS keyserver" />

<p className={"footnote"}>Fox keyservers in the playlist file</p>
...
<p className={"footnote"}>Code snippet taken directly from one of their streams</p>
...
<CustomImage file="site-proxied" footnote="Proxied requests" />

<p className={"footnote"}>Proxied site is just shuttling along the content passed to its url parameter</p>
...
<CustomImage file="streamer-session" footnote="Streamers session" />

<p className={"footnote"}>Valid streamer session credentials</p>
