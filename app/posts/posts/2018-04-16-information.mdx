...
<p className={"caption"}>
  <img alt="Original graph" className={"centered-image"} src="https://assets.jonlu.ca/graph.svg" width="200" />
...
<picture className={"centered-image"}>
  ...
  <img alt="XKCD history" className={"centered-image"} src="https://imgs.xkcd.com/comics/history_2x.png" />
</picture>
