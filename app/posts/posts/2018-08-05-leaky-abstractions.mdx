...
<div id="1" className={"abstractionLayer firstAl"}>
  First Service
</div>
<div id="2" className={"abstractionLayer secondAl"}>
  Second Service
</div>
<div className={"abstractionLayer thirdAl"}>Third Service</div>
...
[^1]: See <a rel="noopener" rel="noreferrer" href="https://www.joelonsoftware.com/2002/11/11/the-law-of-leaky-abstractions/">The Law of Leaky Abstractions</a>

[^2]: Credit to <a rel="noopener" rel="noreferrer" href="https://en.wikipedia.org/wiki/Object-relational_mapping">Wikipedia</a>
