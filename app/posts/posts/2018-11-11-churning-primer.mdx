...
image: "https://assets.jonlu.ca/wallet_status.png"
---
...
<CustomImage file="credit_percents" footnote="Credit percents" />

<p className={"footnote"}>Credit score breakdown</p>
...
<CustomImage file="wallet_status" footnote="My wallet status" />

<p className={"footnote"}>Screenshot of my iOS wallet with some of my frequent traveler cards</p>
