...
<audio controls className={"audio-block"}>
  <source src="https://assets.jonlu.ca/game.mp3" type="audio/mp3" />
  <source src="https://assets.jonlu.ca/game.wav" type="audio/wav" />
  <p>
    Your browser doesn't support HTML5 audio. Here is a{" "}
    <a rel="noopener noreferrer" href="https://github.com/jonluca/Phone-Audio-Processing/tree/master/input">
      link to the audio
    </a>{" "}
    instead.
  </p>
...
<audio controls className={"audio-block"}>
  <source src="https://assets.jonlu.ca/eightkhz_resampled.mp3" type="audio/mp3" />
  <source src="https://assets.jonlu.ca/eightkhz_resampled.wav" type="audio/wav" />
  <p>
    Your browser doesn't support HTML5 audio. Here is a{" "}
    <a rel="noopener noreferrer" href="https://github.com/jonluca/Phone-Audio-Processing/tree/master/output">
      link to the audio
    </a>{" "}
    instead.
  </p>
...
<audio controls className={"audio-block"}>
  <source src="https://assets.jonlu.ca/eightkhz_resampled_unfrequencied.mp3" type="audio/mp3" />
  <source src="https://assets.jonlu.ca/eightkhz_resampled_unfrequencied.wav" type="audio/wav" />
  <span>
    Your browser doesn't support HTML5 audio. Here is a{" "}
    <a rel="noopener noreferrer" href="https://github.com/jonluca/Phone-Audio-Processing/tree/master/output">
      link to the audio
