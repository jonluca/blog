...
image: "https://assets.jonlu.ca/blind-memory-obj.png"
---
...
<CustomImage file="memory" alt="Memory tab" />
...
<CustomImage file="encrypted-memory" alt="An encrypted memory response" />
...
<CustomImage file="blind-memory-obj" alt="Blind" />
