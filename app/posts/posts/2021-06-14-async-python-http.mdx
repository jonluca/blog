...
image: "https://assets.jonlu.ca/python-semaphore-optimal.png"
---
...
<CustomImage file="python-gen1" alt="Python Gen 1" />
...
<CustomImage file="python-gen2" alt="Python Gen 2" />
...
<CustomImage file="python-gen3" alt="Python Gen 3" />
...
<CustomImage file="python-4k-optimal" alt="Python Gen 3 w/ 4000 requests" />
...
<CustomImage file="python-gen3-4k-threads" alt="ThreadPool at 4000 requests w/ 100 threads" />
...
<CustomImage file="python-4k-semaphore" alt="Python Gen 3 semaphore w/ 4000 concurrent requests" />
...
<CustomImage file="python-semaphore-optimal" alt="Finding the optimal semaphore value" />
...
<CustomImage file="python-httpx" alt="HTTPX speeds" />

I also tried a native gather, with punting the concurrency down to the library - this did not help either.

<CustomImage file="python-httpx-gather" alt="HTTPX without a semaphore" />
...
<CustomImage file="pycurl" alt="PyCurl implementation" />
...
<CustomImage file="pycurl-results" alt="PyCurl results" />
...
<CustomImage file="uvloop-email" alt="uvloop email" />
...
<CustomImage file="uvloop" alt="speed results for uvloop" />
