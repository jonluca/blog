...
image: "https://assets.jonlu.ca/amex-nmap.png"
---
...
<CustomImage file="amex-scam-email" footnote="Amex scam email" />

<p className={"footnote"}>"American Express" Email</p>
...
<CustomImage file="amex-dns" footnote="DNS of scam site" />

<p className={"footnote"}>Preventing ANY DNS queries</p>
...
<CustomImage file="amex-dns-valid" footnote="Amex DNS scam site" />

<p className={"footnote"}>Getting all records with any hostnames</p>

They all point to `208.91.197.90`. An nmap scan reveals that the only two ports open are 53 and 80.

<CustomImage file="amex-nmap" footnote="Scam amex nmap" />

<p className={"footnote"}>Nmap scan of the domain.</p>
...
<CustomImage file="trnsfrmedia" footnote="Scam site hosting js" />

<p className={"footnote"}>Host of the JS file</p>
...
<CustomImage file="amex-scam-site" footnote="Scam amex site" />

<p className={"footnote"}>"American Express" site</p>
...
<CustomImage file="amex-scam-route" footnote="scam amex route" />

<p className={"footnote"}>"American Express" data submission</p>
