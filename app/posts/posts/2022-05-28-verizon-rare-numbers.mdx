...
image: "https://assets.jonlu.ca/verizon-search.png"
---
...
<CustomImage file="verizon-search" alt="Verizons search UI" style={{ maxHeight: "400px", height: "auto", maxWidth: "100%" }} />
...
<CustomImage file="verizon-search-endpoint" alt="Verizons search endpoint" />
...
<CustomImage file="verizon-resp" alt="Verizons search endpoint response" />
...
<CustomImage file="verizon-success" alt="Verizons numbers with consecutive digits" />
