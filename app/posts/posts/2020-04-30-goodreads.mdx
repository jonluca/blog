...
image: "https://assets.jonlu.ca/goodreads.png"
---
...
<CustomImage file="goodreads" footnote="Good Reads TTFB is nearly 5 seconds" alt="good reads TTFB" />
...
<CustomImage file="goodreads2" footnote="Next request" alt="good reads TTFB" />
...
<Video src="https://assets.jonlu.ca/goodreads.mp4" footnote="Good reads initial site load video" />
