...
image: "https://assets.jonlu.ca/whale.png"
---
...
<CustomImage file="whale" footnote="We could fit every word every said inside the volume of a blue whale" alt="Blue whale" />
...
<CustomImage file="freight" footnote="Compressed? Less than half of a freight container" alt="freight container" />
