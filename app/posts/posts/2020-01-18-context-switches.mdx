...
<img alt="xkcd" className={"centered-image"} src="https://imgs.xkcd.com/comics/is_it_worth_the_time.png" />
<p className={"footnote"}>https://xkcd.com/1205/</p>

<img alt="xkcd" className={"centered-image"} src="https://imgs.xkcd.com/comics/automation.png" />
<p className={"footnote"}>https://xkcd.com/1319/</p>
...
<CustomImage file="contextswitch" footnote="<a href=" alt="Context switches for programmers" />
