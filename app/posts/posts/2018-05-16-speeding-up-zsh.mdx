...
image: "https://assets.jonlu.ca/rawbash.png"
---
...
<CustomImage file="origzsh" footnote="Original zsh profile" />
...
<CustomImage file="rawbash" footnote="Raw bash speeds" />
...
<CustomImage file="rawzsh" footnote="Raw zsh speeds" />
...
<CustomImage file="zshNoOmzNoNvm" footnote="Zsh speeds with no Oh my zsh or nvm" />
...
<CustomImage file="profiledfuncs" footnote="Profile functions" />
...
<CustomImage file="postopt" footnote="Post changes to startup" />
...
<CustomImage file="zsh_final" footnote="Final zsh speeds" />
